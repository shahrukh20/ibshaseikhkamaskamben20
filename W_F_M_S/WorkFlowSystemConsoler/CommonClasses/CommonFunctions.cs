...
using WorkFlowSystemConsoler.BLL.Context;

namespace WorkFlowSystemConsoler.CommonClasses
{
    public class CommonFunctions
    {
        ...
        public WorkFlowSystemConsoler.Models.UserType GetUserType(string UserName)
        {
...
where usr.Name='{0}'";
            ...
            WorkFlowSystemConsoler.Models.UserType UserType = db.Database.SqlQuery<WorkFlowSystemConsoler.Models.UserType>(parameterizedquery).FirstOrDefault();
            return UserType;
        }
