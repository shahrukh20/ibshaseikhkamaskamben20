...
using WorkFlowSystemConsoler.BLL.Enum;
using System;
...
namespace WorkFlowSystemConsoler.WebForms
{
    public partial class ReportViwer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rd.Load(path);
            //rd.DataSourceConnections[0].SetConnection(@"DESKTOP-R4OEROM\SQLEXPRESS", "WorkFlowSystemConsoler_DB", false);
            //rd. = null;
            rd.SetDataSource(ds);

            //foreach (ReportDocument item in rd.Subreports)
            //{
            //    item.DataSourceConnections[0].SetConnection(@"DESKTOP-R4OEROM\SQLEXPRESS", "WorkFlowSystemConsoler_DB", false);
            //}
